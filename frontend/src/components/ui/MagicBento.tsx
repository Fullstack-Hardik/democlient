...
import { SiNodedotjs, SiMongodb, SiReact, SiNextdotjs, SiJavascript, SiTailwindcss, SiVite } from 'react-icons/si';
...
const cardData = [
  ...
  },
  {
    color: '#120F17',
    title: 'JavaScript',
    description: 'Dynamic language of the web.',
    label: 'Language',
    icon: SiJavascript,
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    const updateSpotlight = () => {
      if (!spotlightRef.current || !gridRef.current || !lastEvent) return;
      const e = lastEvent;
...
const MagicBento = ({
  ...
  return (
    <section className="py-32 w-full bg-[#050505] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10 mb-16 text-center">
        <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white">
          My <span className="text-[#ff5800]">Skills</span>
        </h2>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardContent = (
            <>
              {/* Giant Blurred Transparent Background Logo */}
              <div className="absolute right-[-15%] bottom-[-15%] w-[80%] h-[80%] z-0 pointer-events-none opacity-30 filter blur-[4px] flex items-end justify-end transform -rotate-12">
                <IconComponent className="w-full h-full" style={{ color: `rgb(${currentGlowColor})` }} />
              </div>
              
              <div className="magic-bento-card__header">
                <div className="magic-bento-card__label" style={{ backgroundColor: `rgba(${currentGlowColor}, 0.2)` }}>
                  {card.label}
                </div>
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-black/50 z-10">
