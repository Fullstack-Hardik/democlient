...
export function HorizontalFeatureReveal() {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen bg-black text-white overflow-hidden" id="services">
      ...
      <div ref={containerRef} className="flex h-full w-[400vw]">
        {FEATURES.map((feature, i) => (
          <div key={i} className="feature-slide w-screen h-full flex-shrink-0 flex items-center justify-center px-4 md:px-20">
