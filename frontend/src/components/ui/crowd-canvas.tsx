...
const Skiper39 = () => {
  return (
    <div className="relative h-full min-h-[400px] w-full bg-[#050505] text-white overflow-hidden pointer-events-none opacity-40">
      <div className="absolute bottom-0 h-[400px] w-screen">
