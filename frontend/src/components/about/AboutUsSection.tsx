        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              <motion.div
                className="rounded-3xl overflow-hidden shadow-2xl shadow-orange-500/20"
...
function ServiceItem({ icon, secondaryIcon, title, description, variants, delay, direction }: ServiceItemProps) {
  return (
    ...
    >
      ...
      <motion.div
        className="mt-3 pl-14 flex items-center text-orange-400 text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0 }}
      >
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    <motion.div
      className="bg-black border border-white/5 p-6 rounded-3xl flex flex-col items-center text-center group hover:border-orange-500/30 transition-colors duration-300"
      variants={{
    ...
    >
      <motion.div
        className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-4 text-gray-400 group-hover:bg-orange-500/20 group-hover:text-orange-400 group-hover:border-orange-500/30 transition-all duration-300"
      ...
      <motion.div className="w-10 h-1 rounded-full bg-orange-600 mt-4 group-hover:w-16 transition-all duration-300" />
    </motion.div>
  )
}
