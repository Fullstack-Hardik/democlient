...
.cinematic-footer-wrapper {
  ...
  --pill-bg-1: color-mix(in oklch, white 3%, transparent);
  --pill-bg-2: color-mix(in oklch, white 1%, transparent);
  --pill-shadow: color-mix(in oklch, black 50%, transparent);
  --pill-highlight: color-mix(in oklch, white 10%, transparent);
  --pill-inset-shadow: color-mix(in oklch, black 80%, transparent);
  --pill-border: color-mix(in oklch, white 8%, transparent);
  
  --pill-bg-1-hover: color-mix(in oklch, white 8%, transparent);
  --pill-bg-2-hover: color-mix(in oklch, white 2%, transparent);
  --pill-border-hover: color-mix(in oklch, white 20%, transparent);
  --pill-shadow-hover: color-mix(in oklch, black 70%, transparent);
  --pill-highlight-hover: color-mix(in oklch, white 20%, transparent);
}
...
.footer-aurora {
  background: radial-gradient(
    circle at 50% 50%, 
    color-mix(in oklch, white 15%, transparent) 0%, 
    color-mix(in oklch, gray 15%, transparent) 40%, 
    transparent 70%
  );
}
...
.footer-giant-bg-text {
  ...
  color: transparent;
  -webkit-text-stroke: 1px color-mix(in oklch, white 5%, transparent);
  background: linear-gradient(180deg, color-mix(in oklch, white 10%, transparent) 0%, transparent 60%);
...
/* Metallic Text Glow */
.footer-text-glow {
  background: linear-gradient(180deg, white 0%, color-mix(in oklch, white 40%, transparent) 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  filter: drop-shadow(0px 0px 20px color-mix(in oklch, white 15%, transparent));
}
`;
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="#" className="footer-glass-pill px-10 py-5 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group">
                  <svg className="w-6 h-6 text-white/50 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton as="a" href="#" className="footer-glass-pill px-6 py-3 rounded-full text-white/50 font-medium text-xs md:text-sm hover:text-white">
                  Privacy Policy
                </MagneticButton>
                <MagneticButton as="a" href="#" className="footer-glass-pill px-6 py-3 rounded-full text-white/50 font-medium text-xs md:text-sm hover:text-white">
                  Terms of Service
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">MyBrand</span>
            </div>
